            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            ...
                            Name 
                            <a href="{{ route('home', ['sort_field' => 'name', 'sort_order' => 'asc']) }}">ASC</a></br>
                            Name 
                            <a href="{{ route('home', ['sort_field' => 'name', 'sort_order' => 'desc']) }}">DESC</a>
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                            Username 
                            <a href="{{ route('home', ['sort_field' => 'username', 'sort_order' => 'asc']) }}">ASC</a></br>
                            Username 
                            <a href="{{ route('home', ['sort_field' => 'username', 'sort_order' => 'desc']) }}">DESC</a>
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                            Email
                            </th>
